    ...
    <header className="w-full bg-white border border-[#E2E8F0] rounded-2xl px-4 sm:px-5 py-3 flex items-center justify-between text-xs select-none">
      ...
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 rounded-full bg-[#EBF8FF] border border-[#66CCFF]/40 flex items-center justify-center text-[#0099FF]">
            <Gamepad2 size={15} />
          </div>
          <span className="font-extrabold text-[#0F172A] text-sm tracking-tight">贪吃蛇</span>
          <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-[#EBF8FF] border border-[#66CCFF]/30 text-[#0099FF]">
            经典版
          </span>
        </div>
      ...
      <div className="flex items-center gap-1.5 sm:gap-2">
        ...
        <button
          ...
          title="游戏规则与新手指南"
          className="w-8 h-8 rounded-full flex items-center justify-center text-[#64748B] hover:text-[#8B5CF6] hover:bg-[#EDE9FE] transition-all cursor-pointer"
        >
          <HelpCircle size={16} />
        </button>
