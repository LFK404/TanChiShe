  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-[4px] animate-fade-in select-none">
      <div className="w-full max-w-md bg-white rounded-3xl p-6 sm:p-7 flex flex-col text-[#0F172A] relative shadow-2xl">
        ...
        {/* 教程条目 (纯净浅底无边框，仅左侧图标着色，100% 纯矢量) */}
        <div className="flex flex-col gap-2.5 py-3 text-xs text-[#334155]">
          {/* 1. 操控方式 (天青蓝图标) */}
          <div className="flex items-start gap-3 p-3 bg-slate-50/90 rounded-2xl">
          ...
          <div className="flex items-start gap-3 p-3 bg-slate-50/90 rounded-2xl">
            ...
            <div>
              ...
              <p className="text-[#64748B] text-[11.5px] leading-relaxed">
                每局 25% 概率出现，限时 <strong className="text-[#0F172A]">8 秒</strong> 顶部倒计时！吃掉斩获 +30 高额积分，但 <strong className="text-[#0F172A]">残留栅栏会继续保留</strong>，考验走位极限！
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 p-3 bg-slate-50/90 rounded-2xl">
            ...
            <div>
              ...
              <p className="text-[#64748B] text-[11.5px] leading-relaxed">
                得分越高，蛇速自动平滑递增（最高 2.0x 极速）。打破纪录后自动同步全服 Top 10 排行榜！
              </p>
            </div>
          </div>
        </div>
