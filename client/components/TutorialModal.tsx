    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-[4px] animate-fade-in select-none">
      <div className="w-full max-w-md bg-white border border-[#E2E8F0] rounded-3xl p-6 sm:p-7 flex flex-col text-[#0F172A] relative">
        ...
        <div className="flex flex-col gap-3 py-4 text-xs text-[#334155]">
          {/* 1. 操控方式 (天青蓝 #66CCFF) */}
          <div className="flex items-start gap-3 p-3 bg-[#EBF8FF] border border-[#66CCFF]/30 rounded-2xl">
            <div className="w-6 h-6 rounded-xl bg-white border border-[#66CCFF]/40 flex items-center justify-center text-[#0099FF] shrink-0 mt-0.5">
              🕹️
            </div>
            <div>
              <strong className="text-[#0369A1] block font-bold mb-0.5">基础操作与转向</strong>
              <p className="text-[#0284C7] text-[11.5px] leading-relaxed">
          ...
          {/* 2. 普通红果 (珊瑚红) */}
          <div className="flex items-start gap-3 p-3 bg-rose-50/70 border border-rose-100 rounded-2xl">
            <div className="w-6 h-6 rounded-xl bg-rose-50 border border-rose-200 flex items-center justify-center text-rose-500 shrink-0 mt-0.5">
              <Apple size={14} />
            </div>
            <div>
              <strong className="text-rose-900 block font-bold mb-0.5">普通红苹果 (+10分 · 清空栅栏)</strong>
          ...
          {/* 3. 金色幸运果 (暖琥珀金) */}
          <div className="flex items-start gap-3 p-3 bg-[#FEF3C7]/60 border border-[#F59E0B]/30 rounded-2xl">
            <div className="w-6 h-6 rounded-xl bg-[#FEF3C7] border border-[#F59E0B]/30 flex items-center justify-center text-[#D97706] shrink-0 mt-0.5">
              <Sparkles size={14} />
            </div>
            <div>
              <strong className="text-[#92400E] block font-bold mb-0.5">金色幸运果 (+30分 · 保留栅栏)</strong>
          ...
          <div className="flex items-start gap-3 p-3 bg-purple-50/70 border border-purple-100 rounded-2xl">
            <div className="w-6 h-6 rounded-xl bg-purple-50 border border-purple-200 flex items-center justify-center text-purple-600 shrink-0 mt-0.5">
              <Zap size={14} />
            </div>
            <div>
              <strong className="text-purple-900 block font-bold mb-0.5">动态速度与冲榜</strong>
              <p className="text-purple-700 text-[11.5px] leading-relaxed">
